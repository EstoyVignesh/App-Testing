...
public class JailerPage1 extends SeWrappers
{
...
public WebElement connname;

@FindBy(xpath="//input[@name='Base URL']")
public WebElement baseurl;


@FindBy(xpath="//input[@name='API Key']")
public WebElement key;


@FindBy(xpath="//button[text()='Validate your account']")
public WebElement val;


@FindBy(xpath="//button[text()='Save your account']")
...
public void connectionName(String text)
{
	waitForElement(connname,30);
	typeText(connname,text);
}

public void connectionURL(String text)
{
	waitForElement(baseurl,30);
	typeText(baseurl,text);
}

public void apiKey(String text)
{
	waitForElement(key,30);
	typeText(key,text);
}

public void validaate()
{
	waitForElement(val,30);
	clickElement(val);
}
